...
export const pricingContent = {
  eyebrow: "Pricing",
  title: "We earn only when\nyou earn.",
  subtitle:
    "No monthly fee. No hidden FX. One transparent commission on every sale — nothing more.",
  footnote:
    "No credit card required · Transparent FX · Lifetime buyer access guarantee · NDPR compliant",
  tiers: [
    {
      plan: "Free",
      commission: "5%",
      ...
      features: [
        ...
        "Digital products, events, bookings",
        "Instant payouts · transparent FX",
        "Coupon engine + retainer plans",
        "Analytics + CSV export",
        "3 team members",
      ],
      cta: { label: "Start selling free", href: "/coming-soon" },
      featured: false,
    ...
    },
    {
      ...
      commission: "2%",
      commissionNote: "per sale",
      threshold: "For sellers doing ₦500k+/month",
      badge: "Best value",
      features: [
        "Everything in Free",
      ...
      cta: { label: "Apply for Pro", href: "/coming-soon" },
      featured: true,
    ...
    },
    {
      ...
      commission: "Custom",
      commissionNote: "rate",
      threshold: "For agencies and high-volume sellers",
      features: [
        "Everything in Pro",
        "Custom FX rate policy",
        "Dedicated account manager",
        "Volume commission discount",
        "SLA + uptime guarantee",
        "Custom onboarding",
      ],
      cta: { label: "Talk to us", href: "/coming-soon" },
      featured: false,
      buttonVariant: "pill-dark" as const,
    },
  ],
