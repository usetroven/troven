...
export function Differentiators() {
  return (
    <div className="border-t border-black/7 bg-surface">
      <section className="mx-auto max-w-[1200px] px-6 py-14 md:px-12 md:py-[100px]">
        ...
        <div className="mt-10 grid grid-cols-2 gap-px overflow-hidden rounded-3xl bg-black/7 md:mt-14 md:grid-cols-4">
